  ...
  return (
    <Tabs defaultValue="profile-details" className="w-full md:w-1/2 my-5 mx-auto flex-col justify-around">
      <TabsList className="grid w-full bg-secondary p-1 grid-cols-2 rounded-lg my-10 font-bold">
        <TabsTrigger value="profile-details" className="data-[state=active]:bg-background p-2 rounded">Profile Details</TabsTrigger>
        <TabsTrigger value="work-preferences" className="data-[state=active]:bg-background p-2  rounded">Work Preferences</TabsTrigger>
      </TabsList>
